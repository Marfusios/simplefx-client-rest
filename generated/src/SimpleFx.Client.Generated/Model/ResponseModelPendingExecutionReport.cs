...
{
    /// <summary>
    /// ResponseModelPendingExecutionReport
    /// </summary>
    [DataContract]
    public partial class ResponseModelPendingExecutionReport :  IEquatable<ResponseModelPendingExecutionReport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseModelPendingExecutionReport" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResponseModelPendingExecutionReport() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseModelPendingExecutionReport" /> class.
        /// </summary>
        ...
        public ResponseModelPendingExecutionReportData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseModelPendingExecutionReport {\n");
        ...
        {
            return this.Equals(input as ResponseModelPendingExecutionReport);
        }

        /// <summary>
        /// Returns true if ResponseModelPendingExecutionReport instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseModelPendingExecutionReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseModelPendingExecutionReport input)
        {
            if (input == null)
                return false;
