...
namespace SimpleFx.Client.Generated.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(InlineResponse200Data data = default(InlineResponse200Data), int code = default(int), string message = default(string), string webRequestId = default(string))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for InlineResponse200 and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for InlineResponse200 and cannot be null");
            }
            else
            {
