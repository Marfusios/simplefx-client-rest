...
namespace SimpleFx.Client.Generated.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        public InlineResponse2002(List<Mt4Account> data = default(List<Mt4Account>), int code = default(int), string message = default(string), string webRequestId = default(string))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse2002 and cannot be null");
            }
            else
            {
                this.Data = data;
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for InlineResponse2002 and cannot be null");
            }
            else
            {
                this.Code = code;
        ...
        public List<Mt4Account> Data { get; set; }
