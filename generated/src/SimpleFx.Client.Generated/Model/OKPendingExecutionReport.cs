...
namespace SimpleFx.Client.Generated.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OKPendingExecutionReport :  IEquatable<OKPendingExecutionReport>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OKPendingExecutionReport {\n");
        ...
        {
            return this.Equals(input as OKPendingExecutionReport);
        }

        /// <summary>
        /// Returns true if OKPendingExecutionReport instances are equal
        /// </summary>
        /// <param name="input">Instance of OKPendingExecutionReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OKPendingExecutionReport input)
        {
            if (input == null)
                return false;
